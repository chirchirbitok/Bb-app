  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<br />
		<table  align="center" >
			<tr>
				<td>
					<h2><a href="profile2.php?userId=<?=$_SESSION["authlog"]["userId"]?>">Your Profile</a></h2>
				</td>
			</tr>
			<tr>
				<td>
					<h2><a href="coach.php">Edit Coach Information</a></h2>
				</td>
			</tr>
			<tr>
				<td>
					<h2><a href="players2.php">Edit Player Information</a></h2>
				</td>
			</tr> 

			<tr>
				<td>
					<h2><a href="updateinfonews.php">Update News Information</a></h2>
				</td>
			</tr> 
			<tr>
				<td>
					<h2><a href="schedule.php">Update Live Scores</a></h2>
				</td>
			</tr> 

			<!-- <tr>
				<td>
					<h2><a href="Shoppinginsert.php">Shopping Cart</a></h2>
				</td>
			</tr> --> 
