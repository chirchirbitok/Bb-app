      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li style="float:right;"><a href="profile.php?userId=<?=$_SESSION["authlog"]["userId"]?>"><img style="width:30px; height:25px; background-color:white;" src="images/people/<?php echo $_SESSION["authlog"]["Image"];?>"><?php echo ' ';?>View profile</a></li>
...
<td><a href="add.php"><button class="btn btn-secondary">Add a User</button>
</a>
<div class="container">
...
if ($results->num_rows>0){
 ...
 ?>
  ...
  <td align="center"><a href="delete.php?userId=<?= $row['userId']?>" ><button class="btn btn-secondary">Delete</button>
          <td align="center"><a href="review.php?userId=<?= $row['userId']?>" ><button class="btn btn-secondary">Update</button>
 </tr>
 <?php
 }
}else {
