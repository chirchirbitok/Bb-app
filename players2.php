...
<table id="myTable">
  ...
  <?php 
$select_qry="SELECT `playerId`, `playerName`, `teamId`, `height`, `weight`, `age` FROM `players` ";
...
if ($results->num_rows>0){
 ...
 ?>
  ...
  <td align="center"><a href= "review4.php?playerId=<?= $row['playerId']?>"><button class="btn btn-secondary">Update</button>
  <td align="center"><a href="delete4.php?playerId=<?= $row['playerId']?>"><button class="btn btn-secondary">Delete</button>
 </tr>
 <?php
}
}else {
