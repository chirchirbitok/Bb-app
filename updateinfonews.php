        ...
        <div class="col-md-12">
            <div class="well well-sm">
                <form class="form-horizontal" method="post" action="process_news.php" >
                    <fieldset>
                        <legend class="text-center header">News Information</legend>
                        

                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
                            <div class="col-md-8">
                                <input id="title" name="title" value = "<?php if(isset($_SESSION['title'])){ echo stripslashes($_SESSION['title']); unset($_SESSION['title']); } ?>" type="text" placeholder="News Title" class="form-control" required = "">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
                            <div class="col-md-8">
                                <textarea class="form-control" id="news_short_description" name="news_short_description" value = "<?php if(isset($_SESSION['news_short_description'])){ echo stripslashes($_SESSION['news_short_description']); unset($_SESSION['news_short_description']); } ?>"placeholder="News short description." required = "" rows="7"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-pencil-square-o bigicon"></i></span>
                            <div class="col-md-8">
                                <textarea class="form-control" id="news_full_content" name="news_full_content" value = "<?php if(isset($_SESSION['news_full_content'])){ echo stripslashes($_SESSION['news_full_content']); unset($_SESSION['news_full_content']); } ?>" placeholder="News full content" required = "" rows="7"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="news_author" name="name" value = "<?php if(isset($_SESSION['name'])){ echo stripslashes($_SESSION['name']); unset($_SESSION['name']); } ?>" type="text" placeholder="News Author" class="form-control" required = "">
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-md-12 text-center">
                                <button type="submit" name="overview_details" class="btn btn-primary btn-lg">Submit</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
