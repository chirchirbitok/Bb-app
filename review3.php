...
if (isset($_GET["coachId"])){
  ...
  $select_qry = " SELECT `coachId`, `coachName`, `teamId` FROM `coaches` WHERE coachId='$coachId' limit 1";
...
<h1 align="center"><b><?php echo strtoupper($row["coachName"])."'S PROFILE"; ?></b></h1>
<p>
...
<table align="center" >
  <form action = "update3.php" method = "POST">
      ...
      <td>
        <input type="int" name="coachId" value="<?php echo ucfirst($row["coachId"]); ?>">
      </td>
    </tr>
    <tr>
    <tr>
      <th align="center">COACH NAME:</th>
      <td>
        <input type="text" name="coachName" value="<?php echo ucfirst($row["coachName"]); ?>">
      </td>
    </tr>
