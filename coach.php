...
<table id="myTable">
  <tr class="header">
    ...
    <th style="width:20%;">Action1</th>
    <th style="width:20%;">Action2</th>
   
  </tr>
  <?php 
$select_qry="SELECT `coachId`, `coachName`, `teamId` FROM `coaches`";
...
if ($results->num_rows>0){
 ...
 ?>
  <tr>
  <td align="center" scope="row"><?php echo $row["coachId"]; ?></td>
  <td align="center" scope="row"><?php echo $row["coachName"]; ?></td>
  <td align="center" scope="row"><?php echo $row["teamId"]; ?></td>

    <td align="center"><a href= "review3.php?coachId=<?= $row['coachId']?>"><button class="btn btn-secondary">Update</button>
  <td align="center"><a href="delete3.php?coachId=<?= $row['coachId']?>"><button class="btn btn-secondary">Delete</button>
